...
<div id="hmcs-wrap-all" class="wrap hmcs-settings-wrap">
    ...
    <div class="hmcs-header-bar">
        <div class="hmcs-header-left">
            <h2 class="hmcs-header-title"><i class="fa fa-paint-brush" aria-hidden="true"></i>&nbsp;<?php _e('Styles Settings', 'hm-resume-manager'); ?></h2>
        </div>
    </div>
    ...
    <div class="hmrm-wrap">
        ...
        <div class="hmrm_personal_wrap hmrm_personal_help" style="width: 75%; float: left;">
            ...
            <form name="hmrm_general_settings_form" role="form" class="form-horizontal" method="post" action="" id="hmrm-general-settings-form">
                <?php wp_nonce_field( 'hmrm_styles_action_field', 'hmrm_styles_nonce_field' ); ?>
                <table class="hmrm-styles-table">
                    <tr class="hmrm_bg_color">
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_bg_color"><?php esc_html_e('Background Color', 'hm-resume-manager'); ?></label>
                        </th>
                        <td>
                            <input class="wsp-wp-color" type="text" name="hmrm_bg_color" id="hmrm_bg_color" value="<?php esc_attr_e( $hmrm_bg_color ); ?>">
                            <div id="colorpicker"></div>
                        </td>
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_border_color"><?php esc_html_e('Border Color', 'hm-resume-manager'); ?></label>
                        </th>
                        <td colspan="3">
                            <input class="wsp-wp-color" type="text" name="hmrm_border_color" id="hmrm_border_color" value="<?php esc_attr_e( $hmrm_border_color ); ?>">
                            <div id="colorpicker"></div>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="6" style="font-size: 16px; color:#000;">
                            <hr><b><?php esc_html_e('Personal Info', 'hm-resume-manager'); ?> ::</b><hr>
                        </th>
                    </tr>
                    <tr class="hmrm_name_color">
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_name_color"><?php esc_html_e('Name Color', 'hm-resume-manager'); ?></label>
                        </th>
                        <td>
                            <input class="wsp-wp-color" type="text" name="hmrm_name_color" id="hmrm_name_color" value="<?php esc_attr_e( $hmrm_name_color ); ?>">
                            <div id="colorpicker"></div>
                        </td>
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_name_font_size"><?php esc_html_e('Font Size', 'hm-resume-manager'); ?></label>
                        </th>
                        <td colspan="3">
                            <input type="number" class="small-text" min="12" max="100" name="hmrm_name_font_size" id="hmrm_name_font_size" value="<?php esc_attr_e( $hmrm_name_font_size ); ?>">
                            <code>px</code>
                        </td>
                    </tr>
                    <tr class="hmrm_title_color">
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_title_color"><?php esc_html_e('Title Color', 'hm-resume-manager'); ?></label>
                        </th>
                        <td>
                            <input class="wsp-wp-color" type="text" name="hmrm_title_color" id="hmrm_title_color" value="<?php esc_attr_e( $hmrm_title_color ); ?>">
                            <div id="colorpicker"></div>
                        </td>
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_title_font_size"><?php esc_html_e('Font Size', 'hm-resume-manager'); ?></label>
                        </th>
                        <td colspan="3">
                            <input type="number" class="small-text" min="12" max="100" name="hmrm_title_font_size" id="hmrm_title_font_size" value="<?php esc_attr_e( $hmrm_title_font_size ); ?>">
                            <code>px</code>
                        </td>
                    </tr>
                    <tr class="hmrm_carrer_summary_color">
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_carrer_summary_color"><?php esc_html_e('Career Summary Color', 'hm-resume-manager'); ?></label>
                        </th>
                        <td>
                            <input class="wsp-wp-color" type="text" name="hmrm_carrer_summary_color" id="hmrm_carrer_summary_color" value="<?php echo esc_attr( $hmrm_carrer_summary_color ); ?>">
                            <div id="colorpicker"></div>
                        </td>
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_carrer_summary_font_size"><?php esc_html_e('Font Size', 'hm-resume-manager'); ?></label>
                        </th>
                        <td colspan="3">
                            <input type="number" class="small-text" min="11" max="100" name="hmrm_carrer_summary_font_size" id="hmrm_carrer_summary_font_size" value="<?php esc_attr_e( $hmrm_carrer_summary_font_size ); ?>">
                            <code>px</code>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="6" style="font-size: 16px; color:#000;">
                            <hr><b><?php esc_html_e('Contact Info', 'hm-resume-manager'); ?> ::</b><hr>
                        </th>
                    </tr>
                    <tr class="hmrm_contact_color">
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_contact_color"><?php esc_html_e('Font Color', 'hm-resume-manager'); ?></label>
                        </th>
                        <td>
                            <input class="wsp-wp-color" type="text" name="hmrm_contact_color" id="hmrm_contact_color" value="<?php esc_attr_e( $hmrm_contact_color ); ?>">
                            <div id="colorpicker"></div>
                        </td>
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_contact_font_size"><?php esc_html_e('Font Size', 'hm-resume-manager'); ?></label>
                        </th>
                        <td colspan="3">
                            <input type="number" class="small-text" min="11" max="100" name="hmrm_contact_font_size" id="hmrm_contact_font_size" value="<?php esc_attr_e( $hmrm_contact_font_size ); ?>">
                            <code>px</code>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="6" style="font-size: 16px; color:#000;">
                            <hr><b><?php esc_html_e('Skills', 'hm-resume-manager'); ?> ::</b><hr>
                        </th>
                    </tr>
                    <tr class="hmrm_skill_label_text">
                        <th scope="row" style="text-align: right;">
                            <label
                                for="hmrm_skill_label_text"><?php esc_html_e('Label Text', 'hm-resume-manager'); ?></label>
                        </th>
                        <td>
                            <input type="text" name="hmrm_skill_label_text" placeholder="Skills" class="medium-text" value="<?php esc_attr_e( $hmrm_skill_label_text ); ?>">
                        </td>
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_skill_label_color"><?php esc_html_e('Label Color', 'hm-resume-manager'); ?></label>
                        </th>
                        <td>
                            <input class="wsp-wp-color" type="text" name="hmrm_skill_label_color" id="hmrm_skill_label_color" value="<?php esc_attr_e( $hmrm_skill_label_color ); ?>">
                            <div id="colorpicker"></div>
                        </td>
                        <th scope="row" style="text-align: right;">
                            <label for="hmrm_skill_label_font_size"><?php esc_html_e('Font Size', 'hm-resume-manager'); ?></label>
                        </th>
                        <td>
                            <input type="number" class="small-text" min="14" max="100" name="hmrm_skill_label_font_size" id="hmrm_skill_label_font_size" value="<?php esc_attr_e( $hmrm_skill_label_font_size ); ?>"><code>px</code>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="6" style="font-size: 16px; color:#000;">
                            <hr><b><?php esc_html_e('Education', 'hm-resume-manager'); ?> ::</b><hr>
                        </th>
                    </tr>
                    ...
                    <tr>
                        <th colspan="6" style="font-size: 16px; color:#000;">
                            <hr><b><?php esc_html_e('Experience', 'hm-resume-manager'); ?> ::</b><hr>
                        </th>
                    </tr>
                ...
                <p class="submit">
                    <button id="updateStyleSettings" name="updateStyleSettings" class="hmcs-btn"><?php esc_html_e('Update Styles', 'hm-resume-manager'); ?></button>
                </p>
