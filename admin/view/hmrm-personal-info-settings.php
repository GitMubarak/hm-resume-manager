...
<div id="wph-wrap-all" class="wrap hmrm-settings-page">
    ...
    <form name="hmrm_general_settings_form" role="form" class="form-horizontal" method="post" action="" id="hmrm-general-settings-form">
        ...
        <tr class="hmrm_author_name">
            ...
            <td>
                <input type="text" name="hmrm_author_name" placeholder="Name" class="regular-text" value="<?php echo esc_attr($hmrmGeneralSettings['hmrm_author_name']); ?>">
                <br>
        ...
        <tr class="hmrm_author_title">
            ...
            <td>
                <input type="text" name="hmrm_author_title" placeholder="Title" class="regular-text" value="<?php echo esc_attr($hmrmGeneralSettings['hmrm_author_title']); ?>">
            </td>
        </tr>
        <tr class="hmrm_author_email">
            ...
            <td>
                <input name="hmrm_author_email" type="text" placeholder="Email" class="regular-text" value="<?php echo esc_attr($hmrmGeneralSettings['hmrm_author_email']); ?>">
                <br>
        ...
        <tr class="hmrm_author_website">
            ...
            <td>
                <input name="hmrm_author_website" type="text" placeholder="Website" class="regular-text" value="<?php echo esc_attr($hmrmGeneralSettings['hmrm_author_website']); ?>">
                <br>
        ...
        <tr class="hmrm_current_address">
            ...
            <td>
                <input name="hmrm_current_address" type="text" placeholder="Address" class="regular-text" value="<?php echo esc_attr($hmrmGeneralSettings['hmrm_current_address']); ?>">
            </td>
        </tr>
        <tr class="hmrm_contact_number">
            ...
            <td>
                <input name="hmrm_contact_number" type="text" placeholder="Contact No." class="regular-text" value="<?php echo esc_attr($hmrmGeneralSettings['hmrm_contact_number']); ?>">
            </td>
        </tr>
        <tr class="hmrm_twitter">
            ...
            <td>
                <input name="hmrm_twitter" type="text" placeholder="Twitter" class="regular-text" value="<?php echo esc_attr($hmrmGeneralSettings['hmrm_twitter']); ?>">
            </td>
        </tr>
        <tr class="hmrm_facebook">
            ...
            <td>
                <input name="hmrm_facebook" type="text" placeholder="Facebook" class="regular-text" value="<?php echo esc_attr($hmrmGeneralSettings['hmrm_facebook']); ?>">
            </td>
        </tr>
        ...
        <tr class="hmrm_photograph">
            ...
            <td>
                <input type="hidden" name="hmrm_photograph" id="hmrm_photograph" value="<?php echo esc_attr( $hmrmGeneralSettings['hmrm_photograph'] ); ?>" class="regular-text" />
                <input type='button' class="button-primary" value="<?php echo esc_attr( 'Select Photograph' ); ?>" id="hmrm-media-manager"/>
                <br><br>
                <?php
        ...
        <p class="submit"><button id="updateGeneralSettings" name="updateGeneralSettings" class="button button-primary"><?php esc_attr_e('Update Personal Info', HMRM_TXT_DOMAIN); ?></button></p>
    </form>
</div>