...
<div class="hm_cv_top">
		...
		<div class="hmrm-header-right">
			...
			<div class="hmrm-social">
				<ul class="hmrm-social-ul">
					<li>
						<div class="social-title"><span class="dashicons dashicons-admin-home"></span> <?php echo esc_html($hmrmCurrentAddress); ?></div>
					</li>
					<li>
						<div class="social-title"><span class="dashicons dashicons-admin-site-alt3"></span> <?php echo esc_html($hmrmAuthorWebsite); ?></div>
					</li>
					<li>
						<div class="social-title"><span class="dashicons dashicons-phone"></span> <?php echo esc_html($hmrmContactNo); ?></div>
					</li>
					<li>
						<div class="social-title"><span class="dashicons dashicons-email-alt"></span> <?php echo esc_html($hmrmAuthorEmail); ?></div>
					</li>
					<li>
						<div class="social-title"><span class="dashicons dashicons-twitter"></span> <?php echo esc_html($hmrmTwitter); ?></div>
					</li>
					<li>
						<div class="social-title"><span class="dashicons dashicons-facebook-alt"></span> <?php echo esc_html($hmrmFacebook); ?></div>
					</li>
				</ul>
			</div>
			<!-- PERSONAL INFO ENDED -->
	...
	<div class="hmrm-level-two">
		...
		<div class="hmrm-level-two-right">
			...
			<div class="hmrm-cv-skills">
				<div class="hm_cv_skills_title">SKILLS</div>
	...
	<div class="hm_education">
		<div class="hm_cv_education_title">EDUCATION</div>
		<?php
